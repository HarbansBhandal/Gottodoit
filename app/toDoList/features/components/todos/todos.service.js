// this is our todos front end service which is responsible for getting / posting / putting
// as part of updating our db. It talks to our back end router which in turn talks to the db
// via the model
